...
import { Boxes, Gamepad, Gamepad2, Joystick, Library, Play, Trophy, CircleSlash } from 'lucide-react';
...
export const STATUS_ORDER: GameStatus[] = ['Library', 'Playing', 'Completed', 'Dropped'];
